/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6e4af6d815ecc129cad496ce92e3deff)
// Runtime types generated with workerd@1.20260730.1 2026-08-01 nodejs_compat
interface __BaseEnv_Env {
  BACKUP_KEK_V1: SecretsStoreSecret;
  BACKUP_KEK_V2: SecretsStoreSecret;
  PUSH_KEK_V1: SecretsStoreSecret;
  PUSH_KEK_V2: SecretsStoreSecret;
  PUSH_KEK_V3: SecretsStoreSecret;
  PUSH_VAPID_PRIVATE_KEY: SecretsStoreSecret;
  PUSH_VAPID_PUBLIC_KEY: SecretsStoreSecret;
  PUSH_VAPID_SUBJECT: SecretsStoreSecret;
  PUSH_FCM_SERVICE_ACCOUNT: SecretsStoreSecret;
  PUSH_ACK_HMAC: SecretsStoreSecret;
  BACKUP_KEK_ACTIVE_VERSION: 'v1';
  PUSH_KEK_ACTIVE_VERSION: 'push-kms-v3';
  PUSH_REVOKED_KEY_VERSIONS: '';
  PUSH_VAPID_PRIVATE_KEY_REF: 'secret-ref-vapid-v3';
  PUSH_VAPID_PUBLIC_KEY_REF: 'secret-ref-vapid-public-v3';
  PUSH_VAPID_SUBJECT_REF: 'secret-ref-vapid-subject';
  PUSH_FCM_SERVICE_ACCOUNT_REF: 'secret-ref-fcm-v2';
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./src/kms');
  }
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      Cloudflare.Env,
      | 'BACKUP_KEK_ACTIVE_VERSION'
      | 'PUSH_KEK_ACTIVE_VERSION'
      | 'PUSH_REVOKED_KEY_VERSIONS'
      | 'PUSH_VAPID_PRIVATE_KEY_REF'
      | 'PUSH_VAPID_PUBLIC_KEY_REF'
      | 'PUSH_VAPID_SUBJECT_REF'
      | 'PUSH_FCM_SERVICE_ACCOUNT_REF'
    >
  > {}
}
