-- Homologación SUNAT beta — boleta 03 (va por RC sendSummary, no XML unitario).
...
INSERT OR IGNORE INTO sale_items (
  ...
  'item_stg_rn_beta_03_001',
  'tenant_stg_rosa_negra_001',
  'sale_stg_rn_beta_03_001',
  'Homologacion boleta SUNAT beta',
  1,
  118,
  100,
  '10',
...
WHERE id = 'series_stg_rn_03' AND tenant_id = 'tenant_stg_rosa_negra_001';
