...
| FIS-15 | §5.2c (P1c) | Percepción `02`/Retención `20`: tasas cerradas, redondeo cents server-side (ADR-FISCAL-005) |
...
| ADR-FISCAL-008 | §5.2 | Transporte MISCONFIGURED ≠ mock ACCEPTED (fail-closed plugins) |
