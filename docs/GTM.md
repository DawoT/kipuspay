...
| **GTM-16** | Catálogo multi-variante / unidades de medida + kits BOM + listas de precio (Crece) | Congelado hasta Sprints 18/30 | 0 stock cruzado entre variantes; conversión UM exacta (redondeo servidor, sin `toFixed`); explosión BOM atómica con rollback total; precio resuelto por lista |
