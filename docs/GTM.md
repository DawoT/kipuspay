...
**Claim “analítica predictiva” (Cadena, FASE 6F) descongelada:** la claim “analítica predictiva” del plan Cadena **quedó descongelada** tras el Quality Gate del **Sprint 46** (`docs/ops/s46-forecasting-qg.md`, GTM-01). Vender pronósticos de ventas y detección de quiebre **con disclaimer** (“estimación, no garantía”) y **nunca** como decisión automática de precio/stock; la capability sigue default-off y producción/piloto NO-GO hasta cron/staging real y A+V independiente. Sin el disclaimer o fuera de Cadena, no afirmar la claim.

**Claim “Gerente de Operaciones” (Cadena/Enterprise, FASE 6F) descongelada:** la claim “El único POS que viene con un Gerente de Operaciones incluido” (inteligencia del negocio: agente de insights + Morning Briefing diario) **quedó descongelada** tras el Quality Gate del **Sprint 49** (`docs/ops/s49-insights-qg.md`). El briefing se entrega como data verificable sobre rollups D1, no como “IA que opina”; la capability sigue default-off y producción/piloto NO-GO hasta staging Cloudflare real (Workers AI, cron, KV) y A+V independiente. Sin el disclaimer “datos del servidor, no en vivo” o fuera de Cadena, no afirmar la claim.
...
|---|---|---|---|
| **GTM-01** | Analítica predictiva de Cadena | **Descongelado** tras Sprint 46 | QG `docs/ops/s46-forecasting-qg.md`; disclaimer "estimación, no garantía"; no decisiones automáticas de stock/precio; capability default-off |
