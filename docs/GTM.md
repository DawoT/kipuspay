...
**Gates de claims retail/servicios (FASE 6C-6E):** cotizaciones/presupuestos (**GTM-19**, gate Sprint 33), devolución a proveedor (**GTM-20**, gate Sprint 34), crédito de tienda/gift cards (**GTM-21**, gate Sprint 35), pago en partes/cuotas (**GTM-22**, gate Sprint 36), comisiones de vendedor (**GTM-23**, gate Sprint 37) y pedidos con retiro (**GTM-24**, gate Sprint 43) solo se venden tras el Quality Gate de sus sprints; ventas recurrentes/membresías y caja móvil siguen sus gates S44/S45 (Roadmap FASE 6E). Antes, responder como roadmap con fecha de gate. Sprint 43 tiene software GREEN local, pero GTM-24 permanece **congelado/condicionado**: capability default-off, sin staging ni entrega externa de WhatsApp y sin QA humana + aprobación PM A+V; Web Push permanece en Sprint 45. No prometer entrega WhatsApp ni push como parte del pedido con retiro. La promesa acotada “exporta todo tu historial sincronizado” (GTM §5.7.1) permanece **congelada/condicionada**: Sprint 42 solo tiene software GREEN local, capability default-off; requiere staging Cloudflare real con R2/Workflow/Secrets Store/KMS externos y firma A+V independiente. No implica cambios offline pendientes, restore aplicado, RPO/RTO ni borrado inmediato LPDP; restore apply/DR pertenece al Sprint 48 y LPDP al Sprint 47.
...
### 4.1.1 Matriz de claims, gates y controles (GTM-01..24)
