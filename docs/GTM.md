...
| **Grifos / Estaciones de servicio** | Colas en pista, cálculo manual de detracción diésel a flotas, descuadres por surtidor | *"Surtidor activo, caja cuadrada y flota atendida sin papel."* | Control de surtidores + detracción B2B según política fiscal vigente | **Sprint 21** (QG cerrado) |
...
| **Crece** | S/ 129 (~US\$ 35) | S/ 1,290 (~US\$ 350) | Negocio de 1-3 locales en expansión | Hasta 3 sucursales, **cajas ilimitadas**, comprobantes **incluidos sin sobregiro en pitch** (holgura de plan), **Modo Dueño móvil**, reportes avanzados, **promociones (gate 30)**, **variantes/unidades (gate 31)**, **apartados (gate 32)**, **trazabilidad por número de serie para electrónica/activos (gate 39)**, **venta por peso con balanza compatible o ingreso manual autorizado (gate 40)**, **kits BOM y listas de precio (gate 18)**; etiquetas S41 tienen software GREEN pero claim NO-GO hasta matriz física y firma A+V, soporte estándar |
| **Cadena** | S/ 349 (~US\$ 95) + S/ 39 por sucursal adicional | Igual con 2 meses gratis | Cadenas de 4+ locales | Sucursales ilimitadas, **analítica predictiva y briefing operativo en preparación** (Sprint 46/49; no vendibles hasta evidencia externa y firmas), **fidelización light / puntos** (QG Sprint 24; motor completo = roadmap), **API de integraciones** (QG Sprint 23), **control de compras 3-way (gate Sprints 28–32)**, **recepción parcial de OC (gate Sprint 20)**, **diario contable (gate Sprint 32)**, **ubicaciones/racks por sucursal** (QG Sprint 38), DR/BCP **condicionado a cierre externo de Sprint 48** (no claim activo), account manager dedicado |
...
**Claim “analítica predictiva” (Cadena, FASE 6F) CONGELADA:** el software y el gating Cadena tienen evidencia local y canary técnico, pero no hay MAPE medido/documentado ni cron Cloudflare validado con QA y firmas A+V independientes. Solo se puede mencionar como roadmap en preparación (Sprint 46); no vender pronósticos ni detección de quiebre hasta completar esas evidencias. No se ha definido aquí un umbral MAPE: Staff Data + PM deben fijarlo antes de que la medición pueda demostrar aceptación.

**Claim “Gerente de Operaciones” (Cadena/Enterprise, FASE 6F) CONGELADA:** eliminar de toda comunicación vendible y mantener solo como roadmap en preparación (Sprint 49). La evidencia staging actual mide únicamente el fast path; no demuestra respuesta generativa válida con datos no triviales, SLO general, Cron 3:30/KV, QA humana ni firmas A+V. No usar el título “Gerente de Operaciones” como capacidad disponible.
...
**Gates de claims retail/servicios (FASE 6C-6E):** cotizaciones/presupuestos (**GTM-19**, gate Sprint 33), devolución a proveedor (**GTM-20**, gate Sprint 34), crédito de tienda/gift cards (**GTM-21**, gate Sprint 35), pago en partes/cuotas (**GTM-22**, gate Sprint 36), comisiones de vendedor (**GTM-23**, gate Sprint 37), pedidos con retiro (**GTM-24**, gate Sprint 43), membresías/ventas recurrentes (**GTM-25**, gate Sprint 44) y alertas push/caja móvil (**GTM-26**, gate Sprint 45) solo se venden tras el Quality Gate de sus sprints. GTM-26 tiene software GREEN local, pero permanece **congelado/condicionado**: capabilities default-off, sin Web Push/FCM staging real, Android físico de gama baja con doze/storage/background ni firmas independientes Mobile+QA+Security A+V. La evidencia emulada no es certificación externa; no prometer entrega en offline/doze, compatibilidad Android universal ni detalles sensibles en lockscreen. GTM-25 tiene software GREEN local pero permanece **congelado/condicionado**: capability default-off, sin cron/staging/canary Cloudflare real ni QA humana + aprobación PM A+V; no promete autocobro, almacenamiento de tarjeta/token, push ni servicio recurrente ininterrumpido después de la gracia. La caja ordinaria sí permanece disponible. Antes del cierre externo, responder como roadmap condicionado. Sprint 43 tiene software GREEN local, pero GTM-24 permanece **congelado/condicionado**: capability default-off, sin staging ni entrega externa de WhatsApp y sin QA humana + aprobación PM A+V; Web Push permanece en Sprint 45. No prometer entrega WhatsApp ni push como parte del pedido con retiro. La promesa acotada “exporta todo tu historial sincronizado” (GTM §5.7.1) permanece **congelada/condicionada**: Sprint 42 solo tiene software GREEN local, capability default-off; requiere staging Cloudflare real con R2/Workflow/Secrets Store/KMS externos y firma A+V independiente. No implica cambios offline pendientes, restore aplicado, RPO/RTO ni borrado inmediato LPDP; restore apply/DR pertenece al Sprint 48 y LPDP al Sprint 47.

**Gates de claims retail/inventario (FASE 6B/6D y Sprints 18/20/48):** estas capabilities están especificadas en la arquitectura (Arquitectura §5.3 reglas 5/14–17/23–27/32; Roadmap FASE 6B/6D) pero **no se publican como claims** hasta su Quality Gate: kits BOM y listas de precio múltiples (**retail/food**, gate **Sprint 18** — **QG cerrado**, claim FEFO/farmacia live); recepción parcial de OC (**Cadena**, gate **Sprint 20** — **QG cerrado**, claim `merma_xfer` live); control de compras 3-way (**Cadena**, gates **Sprints 28–32**); promociones y tramos (**Crece**, gate **Sprint 30** — **QG cerrado**, GTM-15); catálogo multi-variante y unidades de medida (**Crece**, gate **Sprint 31**); apartados/anticipos (**Crece**, gate **Sprint 32**); diario contable (**Cadena**, gate **Sprint 32**); **ubicaciones/racks por sucursal** (**Cadena**, gate **Sprint 38 — QG cerrado**); **trazabilidad por serie** (**Sprint 39 — QG cerrado**) y **venta por peso/balanza compatible** (**Sprint 40 — QG cerrado**) están descongeladas con su copy acotado; etiquetas S41 y backup S42 conservan software GREEN local pero claims NO-GO hasta sus evidencias externas/físicas y firmas A+V; DR/BCP (**Cadena**, Sprint 48) sigue **congelado/condicionado**: la simulación restauró `DR_DB` en staging, pero faltan cutover y rollback ensayados y firmas QA/A/V. No usarlo como argumento comercial activo hasta su cierre externo. “Inventario avanzado completo” sigue prohibido antes de cerrar todos esos gates.

**Gates de flujo del cliente (FASE 6G):** el claim **"sube tu catálogo con la cámara" quedó descongelado** tras el Quality Gate del **Sprint 50** (`docs/ops/s50-quick-add-qg.md`): vender la alta rápida por escáner (producto nuevo ~3s, edición de precio/stock por código) y la **venta rápida genérica sin catálogo** (línea marcada "pendiente de catalogar", sin descuento de stock, precio dentro del umbral sin autorización), con capability default-off y producción/piloto NO-GO hasta staging real y A+V. Tras el Quality Gate del **Sprint 51** (`docs/ops/s51-shift-handoff-qg.md`) se descongelan **"cambia de turno sin cerrar caja"** (handoff con PIN temporal de un solo uso, sesión sigue OPEN, conteo intermedio opcional con diferencia auditada) y **"atribuye la venta al vendedor con su badge"** (PIN de caja + badge `EMP-`, atribución en el carrito en <1 s), default-off y con producción/piloto NO-GO hasta staging real y A/V. El claim "asistente de impresora" solo se vende tras el Quality Gate del **Sprint 53**; antes, vender el catálogo por importador CSV/Bsale/Alegra (Sprint 21) y el arqueo Z estándar. Tras el Quality Gate del **Sprint 53** (`docs/ops/s53-hardware-diagnostics-qg.md`) el claim queda **descongelado-condicionado**: software GREEN local con capability default-off, y producción/piloto NO-GO hasta staging real, QA humana con impresora/balanza físicas y firmas A+V independientes; no prometer cobertura de "cualquier" impresora, marca o red. El **setup checklist** y el **Product Tour** son internos de retención, no claims de landing.
...
### 4.1.1 Matriz de claims, gates y controles (GTM-01..26)
...
|---|---|---|---|
| **GTM-01** | Analítica predictiva de Cadena | **CONGELADO**; solo roadmap Sprint 46 | MAPE medido con objetivo aprobado por Staff Data + PM; cron/canary Cloudflare validado; QA y firmas A+V; mantener no-acción automática y capability default-off. QG `docs/ops/s46-forecasting-qg.md` |
...
| **GTM-09** | Exportación, privacidad y conservación | **CONGELADO** tras hallazgos HIGH de seguridad en C2/C3; requiere verificación reforzada y firmas A/V antes de reabrir | Export reproducible, identidad del titular con factor independiente, anonimización atómica, límites de abuso y retención fiscal verificados; no prometer "cuando quieras" antes del gate |
| **GTM-10** | Forecasting y briefing | **CONGELADO**; solo roadmap Sprint 46/49 | Para forecast: MAPE con objetivo aprobado y validación externa. Para briefing: respuesta útil con facts no triviales, SLO general (no solo fast path), Cron/KV, QA y firmas A+V; hechos D1 trazables, PII-free, anti-alucinación e idempotencia comprobados. QGs s46/s49 |
...
| **GTM-17** | Inventario profundo retail: apartados, ubicaciones/racks, números de serie, venta por peso, etiquetas de precio | **Apartados + ubicaciones/racks + trazabilidad por serie + venta por peso descongelados** tras QG S32/S38/S39/S40; etiquetas S41 permanecen congeladas: software GREEN, matriz física/firma A+V NO-GO | Apartado sin CPE hasta conversión; ubicación granular = agregado de sucursal, FEFO multi-rack y transfer intra-sucursal conservativa; serie única, escaneo y garantía reproducible; peso/monto server-side con balanza compatible o ingreso manual autorizado; etiquetas solo imprimen snapshots de precio server-side en impresoras/perfiles compatibles después del gate físico; QG `docs/ops/s32-layaway-journal-qg.md` + `docs/ops/s38-inventory-locations-qg.md` + `docs/ops/s39-inventory-serials-qg.md` + `docs/ops/s40-inventory-scale-qg.md` + `docs/ops/s41-price-labels-qg.md` |
| **GTM-18** | Continuidad del negocio (DR/BCP, Cadena) | **Congelado/condicionado**: software local GREEN; simulacro staging incompleto para RTO; claim/producción NO-GO | El intento `registry-5` acredita restore y RPO observados en `DR_DB` aislado, pero su `rtoMs` se midió antes de `verifyDrReplay` y no califica. Falta desplegar la corrección y repetir el simulacro, ensayar cutover/rollback de tráfico en staging, QA humana y firmas A/V independientes; no publicar RPO/RTO como garantía comercial ni afirmar failover productivo |
...
| **GTM-24** | Pedidos con retiro (Servicios/Retail) | **Congelado/condicionado**: software GREEN local; claim/producción NO-GO | Pedido sin pago/CPE reserva stock; parciales conservativos; snapshot vigente gana; aviso durable antes de expiry release; ordinary checkout/offline nunca bloqueado; capability default-off; QG `docs/ops/s43-customer-orders-qg.md`; faltan staging/piloto externo, QA humana y aprobación PM A+V; no promete WhatsApp ni push, y push permanece en Sprint 45 |
| **GTM-25** | Membresías / ventas recurrentes (Servicios) | **Congelado/condicionado**: software GREEN local; claim/producción NO-GO | Capability default-off; QG `docs/ops/s44-recurring-sales-qg.md`; faltan cron/staging/canary Cloudflare real, QA humana y aprobación PM A+V; copy permitido solo como roadmap condicionado: genera ventas periódicas con deuda y gracia, sin autocobro, almacenamiento de tarjeta/token, push ni garantía de servicio ininterrumpido después de la gracia; la caja ordinaria permanece disponible |
| **GTM-26** | Alertas push operacionales + caja móvil PWA Android | **Congelado/condicionado**: software GREEN local; claim/producción/piloto NO-GO | Capabilities default-off; QG `docs/ops/s45-mobile-push-pos-qg.md`; faltan Web Push VAPID y FCM HTTP v1 en staging real con ACK `DISPLAYED` p95 <10 s y >=99% en red normal, 500 ventas offline sin pérdida en Android físico de gama baja bajo doze/storage/background y firmas independientes Mobile+QA+Security A+V. La simulación local no es certificación externa; no promete entrega offline/doze, compatibilidad Android universal ni datos sensibles en lockscreen |
...
### 5.7.2 Copy de privacidad LPDP (redactado en Sprint 47; publicación suspendida por C2/C3)

> La capability `compliance.lpdp` (Arquitectura §5.3 regla 32a, LPDP-01..04) respalda
> esta copia. **No publicar ni promover política de privacidad self-serve ni copy de
> landing hasta cerrar los hallazgos C2/C3 y obtener aprobación independiente**
> (claim GTM-09 congelado nuevamente). Este copy es el que usa el panel de
...
- *"¿Controlo mi inventario por estantes, equipos por serie y venta por peso?"* → **Sí (GTM-17 / Sprints 38–40):** ubica stock por rack, ofrece trazabilidad por número de serie para electrónica/activos y vende por peso con balanza compatible o ingreso manual autorizado. El peso y monto los recalcula el servidor; el claim no promete compatibilidad universal de hardware, rastreo GPS ni garantía del fabricante. Etiquetas siguen congeladas hasta el gate S41.
