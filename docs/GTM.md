...
| **Crece** | S/ 129 (~US\$ 35) | S/ 1,290 (~US\$ 350) | Negocio de 1-3 locales en expansión | Hasta 3 sucursales, **cajas ilimitadas**, comprobantes **incluidos sin sobregiro en pitch** (holgura de plan), **Modo Dueño móvil**, reportes avanzados, **promociones (gate 29)**, **variantes/unidades (gate 30)**, **apartados (gate 31)**, **kits BOM y listas de precio (gate 18)**, **venta por peso/balanza, series y etiquetas (gates 38–42)**, soporte estándar |
| **Cadena** | S/ 349 (~US\$ 95) + S/ 39 por sucursal adicional | Igual con 2 meses gratis | Cadenas de 4+ locales | Sucursales ilimitadas, analítica predictiva (gate Sprint 46), **motor de fidelización** (gate Sprint 24), **API de integraciones** (gate Sprint 23), **insight del negocio + briefing diario** (gate Sprint 49), **control de compras 3-way (gate Sprints 28–32)**, **recepción parcial de OC (gate Sprint 20)**, **diario contable (gate Sprint 32)**, **multi-almacén/ubicaciones (gate Sprints 38–42)**, **DR/BCP (gate Sprint 48)**, account manager dedicado |
...
**Gates de claims retail/inventario (FASE 6B/6D y Sprints 18/20/48):** estas capabilities están especificadas en la arquitectura (Arquitectura §5.3 reglas 5/14–17/23–27/32; Roadmap FASE 6B/6D) pero **no se publican como claims** hasta su Quality Gate: kits BOM y listas de precio múltiples (**retail/food**, gate **Sprint 18** — **QG cerrado**, claim FEFO/farmacia live); recepción parcial de OC (**Cadena**, gate **Sprint 20**); control de compras 3-way (**Cadena**, gates **Sprints 28–32**); promociones y tramos (**Crece**, gate **Sprint 29**); catálogo multi-variante y unidades de medida (**Crece**, gate **Sprint 30**); apartados/anticipos (**Crece**, gate **Sprint 31**); diario contable (**Cadena**, gate **Sprint 32**); ubicaciones/racks (**Cadena**, gates **Sprints 38–42**); números de serie, venta por peso/balanza y etiquetas de precio (**Crece**, gates **Sprints 38–42**); DR/BCP (**Cadena**, gate **Sprint 48**). Antes del gate, responder como roadmap con fecha de gate; **no prometer** “control de compras”, “diario contable”, “multi-almacén”, “promociones” ni “apartados” como disponibles.
...
| **GTM-15** | Promociones y tramos (Crece/retail) | Congelado hasta Sprint 29 | Precio final impuesto por el servidor (cliente solo envía ID de promo); anti-apilamiento en 100% de combos; promoción sobre lote respeta `batch_id` (FEFO) |
| **GTM-16** | Catálogo multi-variante / unidades de medida + kits BOM + listas de precio (Crece) | Kits BOM + listas: **listo tras QG Sprint 18**; multi-variante/UM: congelado hasta Sprint 30 | 0 stock cruzado entre variantes; conversión UM exacta (redondeo servidor, sin `toFixed`); explosión BOM atómica con rollback total; precio resuelto por lista |
| **GTM-17** | Inventario profundo retail: apartados, ubicaciones/racks, números de serie, venta por peso, etiquetas de precio | Congelado hasta Sprints 31/38–42 | Apartado sin CPE hasta conversión; suma de stock por ubicaciones invariante; seriales duplicados = 422; peso y monto recalculados por servidor (authz sobre umbral); etiquetas solo imprimen precios |
...
- *"¿Puedo armar promociones u ofertas?"* → El motor de promociones (2x1, % fijo, % por umbral de monto/cantidad, precio por tramo) se comunica como claim solo después del Quality Gate del **Sprint 29** (GTM-15). Antes, responder como roadmap; cuando esté habilitado, el precio final siempre lo impone KipusPay desde el servidor, nunca la caja.
- *"¿Manejan tallas, colores o unidades de medida?"* → El catálogo multi-variante y las unidades de medida se comunican como claim solo después del Quality Gate del **Sprint 30** (GTM-16). Antes, productos simples sin variantes; la conversión de unidades se resuelve en el servidor.
...
- *"¿Puedo apartar mercadería y cobrar un adelanto?"* → Los apartados (reserva de ítems + abonos, sin emitir comprobante hasta convertir a venta) se comunican solo después del Quality Gate del **Sprint 31** (GTM-17). Hasta entonces se vende el pago en partes como roadmap (FASE 6C).
...
| *"¿Manejan promociones u ofertas?"* | Tras el Quality Gate del **Sprint 29** (GTM-15): sí, motor de promociones (2x1, % fijo, tramos) con el precio final impuesto por el servidor. Antes del gate: roadmap con fecha de gate; no afirmar "promos" como listas. |
| *"¿Puedo controlar las compras a proveedores?"* | Tras Sprints **28–32** (GTM-13, Cadena): sí, control 3-way (OC + recepción + factura) y recepción parcial de OC desde el Sprint 20. Antes del gate: no prometer "control de compras"; export de datos de ventas sí disponible. |
| *"¿Tienen apartados o reserva de mercadería?"* | Tras el Quality Gate del **Sprint 31** (GTM-17): sí, apartados con abonos que no emiten comprobante hasta convertir a venta. Antes: roadmap con fecha de gate. |
| *"¿Manejan tallas/colores o venta por peso?"* | Variantes y unidades tras el Quality Gate del **Sprint 30** (GTM-16); venta por peso/balanza tras los gates de **Sprints 38–42** (GTM-17). Antes: productos simples y cobro por unidad. |
