...
| **GTM-17** | Inventario profundo retail: apartados, ubicaciones/racks, números de serie, venta por peso, etiquetas de precio | **Apartados + ubicaciones/racks + trazabilidad por serie descongelados** tras QG S32/S38/S39; peso y etiquetas congelados hasta S40–S41 | Apartado sin CPE hasta conversión; ubicación granular = agregado de sucursal, FEFO multi-rack y transfer intra-sucursal conservativa; serie única, escaneo y garantía reproducible; peso/monto server-side; etiquetas solo imprimen precios; QG `docs/ops/s32-layaway-journal-qg.md` + `docs/ops/s38-inventory-locations-qg.md` + `docs/ops/s39-inventory-serials-qg.md` |
...
- *"¿Controlo mi inventario por estantes o racks? ¿Y los equipos por serie?"* → **Sí (GTM-17 / Sprints 38–39):** ubica stock por rack y ofrece trazabilidad por número de serie para electrónica/activos. El claim no promete rastreo GPS ni garantía del fabricante. Venta por peso/balanza y etiquetas siguen congeladas hasta los gates S40–S41.
