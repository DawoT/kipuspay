...
- *"¿Puedo apartar mercadería y cobrar un adelanto?"* → Los apartados (reserva de ítems + abonos, sin emitir comprobante hasta convertir a venta) se comunican solo después del Quality Gate del **Sprint 32** (GTM-17). Hasta entonces se vende el pago en partes como roadmap (FASE 6B).
...
| *"¿Tienen apartados o reserva de mercadería?"* | Tras el Quality Gate del **Sprint 32** (GTM-17): sí, apartados con abonos que no emiten comprobante hasta convertir a venta. Antes: roadmap con fecha de gate. |
