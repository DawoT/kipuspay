...
| **GTM-25** | Membresías / ventas recurrentes (Servicios) | **Congelado**: baseline contractual RED; producción/claim NO-GO | Sprint 44 cerrado con cron real en staging, exactly-once concurrente, venta+CPE/NV+una CxC atómicos, pricing FIXED/CURRENT servidor, gracia sin bloqueo de caja, prorrateo por NC/NV_RETURN, chaos 500 y firmas QA+PM A+V; no promete autocobro ni tarjeta guardada |
