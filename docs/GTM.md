...
| *"¿Tienen API / fidelización como el plan Cadena dice?"* | API de integraciones sí (QG Sprint 23): API keys + webhooks `sale.created` / `cpe.*` (Cadena+). Fidelización puntos = Sprint 24. |
