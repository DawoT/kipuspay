...
| **GTM-26** | Alertas push operacionales + caja móvil PWA Android | **Congelado**: gobernanza y contratos RED; claim/producción NO-GO | Requiere Web Push VAPID y FCM HTTP v1 reales, 0 push sin consentimiento, 0 PII/secreto, ACK `DISPLAYED` p95 <10 s y >=99% en red normal, 500 ventas offline sin pérdida en Android físico de gama baja y firmas Mobile+QA+Security/A+V. No promete entrega offline/doze ni compatibilidad Android universal |
