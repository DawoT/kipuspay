...
| **GTM-24** | Pedidos con retiro (Servicios/Retail) | Congelado hasta QG Sprint 43 | Pedido sin pago/CPE reserva stock; parciales conservativos; snapshot vigente gana; aviso durable antes de expiry release; ordinary checkout/offline nunca bloqueado; Arquitectura §5.10/ADR-0027; baseline actual solo RED |
