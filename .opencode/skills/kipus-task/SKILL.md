...
Decisiones que no se improvisan en el PR: si el cambio implica una elección arquitectónica (canal fiscal, política de stock, modelo de cobro), va como ADR con su fila en el Registry.
